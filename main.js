...
function addExtraRuns(extraRuns) {

    runs += extraRuns;  

    // Add to extras column of current over
    scoreboard[over_no][0] += extraRuns;

    update_score();
    update_scoreboard();
}
document.getElementById("extra_1").onclick = () => addExtraRuns(1);
document.getElementById("extra_2").onclick = () => addExtraRuns(2);
document.getElementById("extra_3").onclick = () => addExtraRuns(3);
document.getElementById("extra_4").onclick = () => addExtraRuns(4);
document.getElementById("extra_5").onclick = () => addExtraRuns(5);
document.getElementById("extra_6").onclick = () => addExtraRuns(6);
